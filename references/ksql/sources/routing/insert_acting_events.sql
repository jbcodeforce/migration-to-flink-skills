INSERT INTO acting_events(name, title, genre) VALUES
    ...
    ('Cillian Murphy', 'Oppenheimer', 'drama'),
    ('Anne Hathaway', 'The Dark Knight Rises', 'action'),
    ...
    ('Tom Hardy', 'The Dark Knight', 'action'),
    ('Joseph Gordon-Levitt', 'The Dark Knight', 'action'),
    ('Anne Hathaway', 'The Dark Knight', 'action'),
    ('Ariana Grande', 'Wicked', 'fantasy');